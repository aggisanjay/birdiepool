...
import { CheckCircle, XCircle, Eye, DollarSign, Clock, Image, Trophy } from 'lucide-react';
            ...
            <CardContent>
                ...
                <div className="flex-1">
                  ...
                  {winner.proof_uploaded_at && (
                    <p className="text-xs text-slate-500">
                      Proof uploaded:{' '}
                      {new Date(winner.proof_uploaded_at).toLocaleDateString('en-GB', {
              ...
              <div className="mt-4 pt-4 border-t border-slate-800 flex flex-wrap gap-2 items-center">
                ...
                {winner.proof_image_url ? (
                  ...
                  <div className="flex items-center gap-2 text-xs text-amber-400 bg-amber-500/10 border border-amber-500/20 rounded-lg px-3 py-1.5">
                    <Image className="w-3.5 h-3.5" />
                    No proof uploaded yet
                  </div>
                )}

                {/* Verify actions (only when pending) */}
                {winner.verification_status === 'pending' && (
                  <>
                    <Button
                      variant="primary"
